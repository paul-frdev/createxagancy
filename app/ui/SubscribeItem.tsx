...
export const SubscribeItem: React.FC<SubscribeItemProps> = ({
  className,
  ...
  return (
    <section className={`w-full ${color}`}>
      <Container
        className={cn(
          `rounded py-8 px-0 xmd:py-16 flex justify-between items-center`,
          isEventId ? 'bg-gradient-to-r from-[rgba(255,63,58,.2)_0%] to-[rgba(247,94,5,.2)_100%]' : '',
          className
        )}
      >
