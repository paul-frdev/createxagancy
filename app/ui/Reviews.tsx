  ...
  return (
    <div className="bg-white rounded shadow-xl py-8 lg:py-14 px-4 md:px-6 lg:px-10">
      <div className="flex justify-start items-start gap-x-[1.875rem] mb-6">
        ...
        <Typography className="text-gray800 font-lato font-normal max-w-[750px] normal-case text-justify sm:text-left mb-0 md:mb-6">{text}</Typography>
      </div>
      <div className="w-full flex justify-start items-start gap-x-[1.25rem]">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <Typography className=" text-gray700 font-lato font-normal normal-case text-center mb-6">{course}</Typography>
        </div>
      </div>
    </div>
  );
