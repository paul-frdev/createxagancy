  ...
  return (
    <div className="w-full max-w-[285px] h-[416px] group mx-auto">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <Typography className=" text-gray700 font-lato font-normal normal-case text-center">{position}</Typography>
      </div>
    </div>
  );
};
...
export const Team: React.FC<TeamProps> = ({ items }) => {
  ...
  const carouselItems = items.map((item) => <CarouselItem key={item.id} {...item} />);
  return (
      ...
      <Container>
        ...
        <div className="flex flex-col xsm:flex-row justify-between items-center">
          <div>
            ...
            <Heading variant="h4" className="text-[2.5rem] md:text-[2.875rem] mb-10 z-[3]">
              Meet our team
            </Heading>
          </div>
