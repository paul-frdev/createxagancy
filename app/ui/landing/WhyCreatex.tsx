    ...
    <section className=" my-[4rem] lg:my-[8rem] relative w-full ">
      ...
      <Container>
        <div className="flex flex-col lg:flex-row justify-between items-center gap-y-8 lg:items-start lg:gap-x-[3.438em]">
          ...
          <div>
            <p className="text-base text-center lg:text-left font-lato font-bold tracking-[1px] leading-[150%] mb-[0.5rem] uppercase">Who we are</p>
            <Heading variant="h3" className="text-center lg:text-left text-[2.2rem] md:text-[2.875rem] font-lato font-black mb-[2.5rem]">
              Why Createx?
            </Heading>
            <ul className="mb-[3rem]">
              {whyCreatexList.map((item) => (
                <li key={item.id} className="flex justify-start items-start gap-x-[1.5rem] text-base font-lato font-normal mb-[0.75rem]">
