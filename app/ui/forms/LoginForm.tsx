  ...
  return (
    <div className="w-full max-w-[390px] mx-auto mx-4">
      ...
      >
        <div className="flex flex-col  justify-between items-center gap-y-8 w-full">
          ...
          <div className="w-full flex justify-between items-center">
            ...
            <Button className=" w-fit bg-transparent hover:bg-transparent text-orange hover:text-orange p-0 border-none hover:border-none underline font-lato font-normal text-[0.88rem]">
              Forgot password?
            </Button>
          </div>
        </div>
      ...
      <div className="flex justify-start items-center">
        <p className="text-[0.88rem] font-lato font-normal">Dont have an account?</p>
