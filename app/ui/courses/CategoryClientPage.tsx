...
export default async function CategoryClientPage() {
  ...
  return <Categories className=" flex-wrap md:flex-nowrap gap-x-2 gap-y-4 md:gap-y-0 justify-start md:justify-between" categoryTitle={categoryTitle} allItems={quantity} />;
}
