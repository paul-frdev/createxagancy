  ...
  return (
    <section className="w-full mt-8 mb-32">
      <Container>
        ...
        <Heading variant="h3" className="text-center text-[2.875rem] mb-[3.75rem]">
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="w-full max-w-[285px] h-auto">
            <div className="w-full flex justify-start mb-4 h-[84px]">
              <span className="text-[2.875rem] w-[84px] h-[84px] text-orange bg-primary bg-opacity-[0.12] rounded-full font-latoBold font-[900] flex justify-center items-center animation-pulse">
                04
              </span>
            </div>
