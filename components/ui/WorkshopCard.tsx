...
export const WorkshopCard: React.FC<WorkshopCardProps> = ({ item }) => {
  ...
  return (
    <div className="w-full h-auto xl:h-[126px] bg-white last:mb-10 rounded mb-6 flex flex-col lg:flex-row justify-between items-center lg:items-start py-4 sm:py-8 px-2 xsm:px-4 sm:px-10 gap-x-[1.5rem] hover:shadow-workshopHover transition-all duration-500">
      ...
      <div>
        <Button variantCss="outline" sizeCss="lg" className=" text-nowrap text-sm">
          View more
        </Button>
      </div>
    </div>
