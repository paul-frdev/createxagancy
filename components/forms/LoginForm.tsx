      ...
      >
        <div className="flex flex-col  justify-between items-center gap-y-8 w-full">
          ...
          <div className='w-full flex justify-between items-center'>
            ...
            <Button className=' w-fit bg-transparent hover:bg-transparent text-orange hover:text-orange p-0 border-none hover:border-none underline font-latoRegular font-[400] text-[0.88rem]'>Forgot password?</Button>
          </div>
        </div>
      </Form>
