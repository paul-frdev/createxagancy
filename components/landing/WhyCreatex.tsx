        ...
        <div className='flex flex-col lg:flex-row justify-between items-center gap-y-8 lg:items-start lg:gap-x-[3.438em]'>
          <div className='w-full flex justify-center'>
            <Image
              ...
              height="0"
              sizes="100vw"
              className="w-full max-w-[702px] bg-cover h-auto lg:h-[560px]"
            />
          </div>
          <div>
            ...
            <Heading variant='h3' className='text-center lg:text-left text-[2.2rem] md:text-[2.875rem] font-latoBold font-[900] mb-[2.5rem]'>Why Createx?</Heading>
