        ...
        <div className=" flex justify-between pt-[2rem] md:pt-[6em]">
          <div>
            ...
            <div className="w-full">
              <Heading
                variant="h1"
                className="text-[2.5rem] sm:text-[3rem] text-center md:text-left lg:text-[4rem] font-latoBlack font-[900] w-full md:max-w-[496px] tracking-[1px] leading-[130%] mb-8 sm:mb-[1.75em]"
              >
            ...
            {statisticsList.map((item) => (
              <React.Fragment key={item.id}>
                <div className="flex flex-col lg:flex-row justify-start items-center gap-x-[0.75em] gap-x-[0.75em]">
                  <span className=" text-[2rem] md:text-[2.875rem] leading-[130%] font-latoBold font-[700] text-nowrap">{item.number}</span>
                  <span className="text-base font-latoRegular font-[400] text-nowrap">{item.text}</span>
                </div>
                {item.id < 4 ? (
                  <div>
