    ...
    <div className="flex justify-start items-center gap-x-[2.5rem] mb-8">
      ...
      <div>
        <Button
          ...
          className={cn(`bg-transparent hover:bg-transparent border-none hover:border-none w-fit p-0`,
        ...
        <Button
          ...
          className={cn(`bg-transparent hover:bg-transparent text-gray800 border-none hover:border-none w-fit p-0`,
