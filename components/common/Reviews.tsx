  ...
  return (
    <div className='bg-white rounded shadow-xl py-8 lg:py-14 px-6 lg:px-10'>
      <div className='flex justify-start items-start gap-x-[1.875rem] mb-6'>
        ...
        <Typography className='text-gray800 font-latoRegular font-[400] max-w-[750px] normal-case text-justify sm:text-left mb-0 md:mb-6'>
          {text}
        </Typography>
      </div>
    ...
    <section className={cn(`w-full bg-gray200 relative`, className)}>
      ...
      <Container>
        <div className='mb-12 relative'>
          ...
          <Heading variant='h4' className='text-center text-[2.4rem] md:text-[2.875rem]'>What our students say</Heading>
