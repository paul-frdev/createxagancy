          ...
          <ul className="flex flex-col justify-start items-center xsm:items-start gap-y-[0.7rem]">
            {navbar.map((item) => (
              <li key={item.id}>
                <Link
                  href="/"
                  className="text-base hover:opacity-[1] transition-all duration-300 text-white opacity-[0.6] leading-[160%] tracking-[1px] font-latoRegular font-[400]"
                >
                  {item.title}
                </Link>
              </li>
          ...
          <ul className="flex flex-col justify-start items-center xsm:items-start gap-y-[0.7rem]">
            {footerLinks.map((item) => (
              <li key={item.id}>
                <Link
                  href="/"
                  className="text-base text-nowrap text-white opacity-[0.6] hover:opacity-[1] transition-all duration-300 leading-[160%] tracking-[1px] font-latoRegular font-[400]"
                >
                  {item.title}
                </Link>
              </li>
